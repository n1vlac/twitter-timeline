  ...
  var TimelineComposer = React.createClass({displayName: 'TimelineComposer',
    ...
    render: function () {
      ...
      if (this.state.isExpanded) {
        tweetActionRow = React.createElement("div", null, React.createElement("div", null, 140 - this.state.inputCharCount), 
          "+ ", React.createElement("button", {class: "btn primary-btn tweet-action tweet-btn js-tweet-btn disabled", type: "button", disabled: "disabled"}, 
          "+ ", React.createElement("span", {class: "Icon Icon--tweet"}), "Tweet"));
      }
