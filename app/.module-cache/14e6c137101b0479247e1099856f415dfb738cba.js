define([
  ...
  var TweetText = React.createClass({displayName: 'TweetText',
    ...
    parseTextForUserMentions: function (text) {
      _.each(this.entities.user_mentions, function (mention) {
        var screenName = mention.screen_name;
        var profileLink = this.constructProfileLink(screenName);
    ...
    render: function () {
      ...
      var displayText = this.parseTextForMedia();

      return (
        React.createElement("div", {className: "tweet-text", style: tweetTextStyle}, displayText)
      );
    }
  })
