define([
  ...
  var TopNavbar = React.createClass({displayName: 'TopNavbar',
    render: function () {
      ...
      return (
        React.createElement("div", {id: "nav-wrapper"}, 
        ...
        React.createElement("div", {className: "sh"}, 
          React.createElement("div", {className: "sh-1"}), 
          React.createElement("div", {className: "sh-2"}), 
          React.createElement("div", {className: "sh-3"}), 
          React.createElement("div", {className: "sh-4"}), 
          React.createElement("div", {className: "sh-5"})
        )
        )
      );
    }
